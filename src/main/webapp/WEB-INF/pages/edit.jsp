...
<%
 NewsInfor newsInfor = (NewsInfor) request.getAttribute("newsInfor");
 System.out.println("*************"+newsInfor.getNewsType().getTypeId());
%>
<body>
<div style="width: 500px;margin: 0 auto;height: 1000px;margin-top: 50px">
  ...
  <form class="form-horizontal" action="doedit" method="post" id="sub">
    <!-- 新闻标题 -->
    <!--隐藏域-->
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10" >
        <select  class="form-control" id="newsType" name="newsType">
          ...
          %>
          <option
                  <c:if test="<%=(list.get(i).getTypeId())==newsInfor.getNewsType().getTypeId()%>">selected="selected"</c:if>
                  value="<%= list.get(i).getTypeId()%>">
    ...
    <div class="form-group ">
      ...
      <div class="col-sm-10">
        <input type="date" class="form-control" id="sendTime" name="sendTime" value="<fmt:formatDate value='${newsInfor.getSendTime()}' pattern='yyyy-MM-dd'></fmt:formatDate>">
