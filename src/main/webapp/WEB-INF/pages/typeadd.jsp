...
<div style="width: 500px;margin: 0 auto;height: 1000px;margin-top: 50px" >
    <nav class="navbar navbar-default" style="padding: 10px;height: 25px;line-height: 25px;font-size: 20px;font-weight: bolder;">添加类别</nav>
    <form class="form-horizontal" action="doaddtype" method="post" id="sub" enctype="multipart/form-data">

        <div class="form-group ">
            <label  class="col-sm-2 control-label">类别名</label>
            <div class="col-sm-10 ">
                <input type="text" class="form-control "  id="newsTitle" placeholder="输入类别" name="typeName">
