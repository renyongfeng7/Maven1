...
<div style="width: 500px;margin: 0 auto;height: 1000px;margin-top: 50px" >
    ...
    <form class="form-horizontal" action="doadd" method="post" id="sub" enctype="multipart/form-data">
        ...
        <div class="form-group ">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" id="sendTime" name="sendTime" value="${newsInfor==null?"":newsInfor.sendTime}<%--<%= request.getAttribute("newsInfor")==null?"":((NewsInfor)request.getAttribute("newsInfor")).getSendTime()%>--%>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="sendUser" disabled="disabled" value="${login.realName}<%--<%=((User)session.getAttribute("login")).getRealName()%>--%>" >
            </div>
        </div>
